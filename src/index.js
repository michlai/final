...
// sqlite3 -csv -header movies.sqlite3 'select "imdbID" as id, "poster", "genre", "runtime", "rating", "released", "plot", "cast", "title" from movies' | csvtojson --maxRowLength=0 > movies.json

// Firebase configuration
var Rebase = require('re-base')
var base = Rebase.createClass({
  apiKey: "AIzaSyBJ6SsbX1U6UeJlETISszoiXw03K474Xgg",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-e72ba.firebaseio.com/", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  viewChanged: function(view) {
    ...
    var movieDataViewChanged = this.state.movies.sort(this.movieCompareByReleased)
    if (view == 'alpha') {
      movieDataViewChanged = this.state.movies.sort(this.movieCompareByTitle)
    }
    this.setState({
      currentView: view,
      movies: movieDataViewChanged
    })
  },
